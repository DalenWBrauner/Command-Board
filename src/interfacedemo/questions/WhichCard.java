...
public class WhichCard extends StackPane implements PlayerQuestion<CardShape> {
	...
	private CardShape[] playerOptions;
	...
	@Override
	public void setOptions(CardShape[] options) {
