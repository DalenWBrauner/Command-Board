...
public class WhichTile extends StackPane implements PlayerQuestion<int[]> {
...
//		System.out.println(playerSelection);
	...
	private int[] posFromString(String str) {
		String[] s = str.split(",");
		int[] pos = new int[2];
		pos[0] = Integer.valueOf(s[0]);
		pos[1] = Integer.valueOf(s[1]);
		return pos;
	}
}